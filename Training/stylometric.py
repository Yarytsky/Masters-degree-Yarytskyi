"""
Модуль витягу 9 стилометричних ознак — спільний для скриптів навчання
та валідації. Реалізує ті ж самі ознаки, що використовуються
у детекторі платформи Osvita (src/js/ai-detector.js).
"""
